...
export const AndroidIcon: React.FC<{ className?: string }> = ({ className }) => (
  <span className={`material-symbols-outlined inline-flex items-center justify-center ${className}`}>android</span>
);

export const AppleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <span className={`material-symbols-outlined inline-flex items-center justify-center ${className}`}>ios_share</span>
);

export const AddToScreenIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2z" />
    </svg>
);

export const IosShareIcon: React.FC<{ className?: string }> = ({ className }) => (
    <span className={`material-symbols-outlined inline-flex items-center justify-center ${className}`}>ios_share</span>
);

export const AppleAppStoreBadge: React.FC<{ className?: string }> = ({ className }) => (
    <div className={`bg-gray-200 text-black rounded-lg px-3 flex items-center gap-2 ${className}`}>
        <AppleIcon className="w-7 h-7 text-2xl" />
        <div className="text-left">
            <p className="text-[11px] font-medium leading-tight">Instalar en</p>
            <p className="text-[18px] font-bold leading-tight">Apple</p>
        </div>
    </div>
);
...
export const GooglePlayBadge: React.FC<{ className?: string }> = ({ className }) => (
    <div className={`bg-gray-200 text-black rounded-lg px-3 flex items-center gap-2 ${className}`}>
        <AndroidIcon className="w-7 h-7 text-green-600 text-2xl" />
        <div className="text-left">
            <p className="text-[11px] font-medium leading-tight">Instalar en</p>
            <p className="text-[18px] font-bold leading-tight">Android</p>
        </div>
    </div>
);

export const CameraIcon: React.FC<{ className?: string }> = ({ className }) => (
    <span className={`material-symbols-outlined inline-flex items-center justify-center ${className}`}>photo_camera</span>
);

export const ShareIcon: React.FC<{ className?: string }> = ({ className }) => (
    <span className={`material-symbols-outlined inline-flex items-center justify-center ${className}`}>share</span>
);
